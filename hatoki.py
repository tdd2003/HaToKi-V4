...
def si():
    ...
    print("Information: https://duydevcoder.info")

def menu():
    sys.stdout.write(f"HaToKi Ddos Update 4.1.1")
    clear()
    print('HaToKi DDoS By TranDucDuy [duydevcoder.info] ')
    print("https://duydevcoder .info")
    print(Fore.YELLOW + """
            ...
            ╚═════════════════════╦═════════════════════════════════════════╦══════════════════════╝
               ...
               ║------------ Link faceBook : https://www.facebook.com/TranDucDuy.Dev -----------║
               ╚════════════════════════╦═══════════════════════════╦═══════════════════════════╝
                     ╔══════════════════╩═══════════════════════════╩═══════════════════╗
                     ║-------------- Vui Long Khong Tan Cong Gov,Edu Xin Cam On Ban. ---------------║ 
                     ╚═════════════╦══════════════════════════════════════╦═════════════╝
                         ╔═════════╩═════════╗                  ╔═════════╩═════════╗
                         ║   duydevcoder.info  ╠══════════════════╣   duydevcoder.info  ║
    ...
    while(True):
        ...
        if cnc == "layer7" or cnc == "LAYER7" or cnc == "L7" or cnc == "l7":
            ...
            try:
                ...
                print(Fore.RED +'Example: http-socket http://duydevcoder.info/ 5000 60')
            ...
            try:
                ...
                print(Fore.RED +'Example: http-raw http://duydevcoder.info/ 60')
            ...
            try:
                ...
                print(Fore.RED +'Example: http-requests http://duydevcoder.info/ 60')
            ...
            try:
                ...
                print(Fore.RED +'Example: http-rand http://duydevcoder.info/ 60')
            ...
            try:
                ...
                print(Fore.RED +'Example: sever http://duydevcoder.info/ GET')
...
[https://hotieubao.info]
            ...
            try:
                cmmnd = cnc.split()[0]
                print("Command: [ " + cmmnd + " ] Co Cai Lon!")
            except IndexError:
                pass
main()
